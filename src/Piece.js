...
const Piece = ({tileDimensions, texture, rotation, pieceType}) => {
    function getPiece() {
    ...
    return <div className="piece" width={tileDimensions.width*getPieceSizesFromPieceType(pieceType)} height={tileDimensions.height*getPieceSizesFromPieceType(pieceType)}>
        {getPiece()}
    </div>
}
